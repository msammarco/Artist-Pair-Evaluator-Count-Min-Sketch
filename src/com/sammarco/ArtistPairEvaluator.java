...
public class ArtistPairEvaluator {
     ...
     * @throws IOException
     */
    public ArtistPairEvaluator(String inputFileName, int matchMin) throws IOException, IllegalArgumentException {
        try (BufferedReader br = new BufferedReader(new FileReader(inputFileName))) {
            ...
            this.countMinSketch = new CountMinSketch(CountMinSketch.DEFAULT_EPSILON, CountMinSketch.DEFAULT_DELTA);
        ...
        for(String [] bandList : bandsList) {
            for (int i = 0; i < bandList.length - 1; i++) {
                for (int k = i; k < bandList.length - 1; k++) {
                    String pair = bandList[i] + "," + bandList[k + 1];
